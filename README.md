...
> ⚠️ Plugin ke **empty ad-slot containers** unme bhi ad codes daal sakte ho — class names: `.nslink-ad-top`, `.nslink-ad-mid`, `.nslink-ad-foot`. Container ke andar ad code rakho aur container ko visible karo (niceh trigger).
...
2.. Chain URLs ko test karo (ya `?skip=1` daal do — timer 1 second fast testing ke liye.
...
### Step  6 — Part  2 (shortener app) jab ayega, deploy
